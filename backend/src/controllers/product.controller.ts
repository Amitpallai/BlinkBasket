...
export const addProduct = async (
  ...
  try {
    const productData: ProductInput = JSON.parse(req.body.productData);
...
export const updateProductById = async (
  ...
  try {
    ...
    let productData: Partial<ProductInput>;
    try {
    ...
    if (productData.offerPrice !== undefined) updateData.offerPrice = productData.offerPrice;
